...
export default function ProfessionalAIReportPage() {
    ...
    return (
      <div className="min-h-screen bg-black flex items-center justify-center">
        <div className="flex flex-col items-center">
          ...
          <p className="text-sm font-bold text-zinc-500 uppercase tracking-widest animate-pulse">Generating Report Engine...</p>
        </div>
      </div>
    );
  }
  ...
  return (
    <div className="min-h-screen bg-zinc-950 text-white print:bg-white print:text-black font-sans pb-32">
      ...
      {/* 8. EXPORT FEATURES (Hidden on print) */}
      <div className="sticky top-0 z-40 bg-zinc-950/80 backdrop-blur-xl border-b border-zinc-800 px-6 py-4 flex items-center justify-between print:hidden">
        <Link href={`/dashboard/history`} className="flex items-center gap-2 text-xs font-bold text-zinc-400 hover:text-white transition">
          <ChevronLeft className="h-4 w-4" /> Back to History
        </Link>
        <div className="flex items-center gap-4">
          <button className="flex items-center gap-2 px-4 py-2 rounded-lg bg-zinc-900 border border-zinc-800 hover:border-zinc-700 text-xs font-bold text-white transition">
      ...
      <div className="max-w-[850px] mx-auto mt-12 print:mt-0 space-y-12 print:space-y-0 print:p-0 p-4">
        ...
        {/* =========================================
            PAGE 1: COVER PAGE
        ========================================= */}
        <div className="bg-black text-white rounded-2xl overflow-hidden border border-zinc-800 print:rounded-none print:border-none print:min-h-screen print:flex print:flex-col print:justify-center relative p-12" style={{ WebkitPrintColorAdjust: 'exact', printColorAdjust: 'exact' }}>
          ...
          <div className="relative z-10 flex flex-col h-full justify-between min-h-[600px] print:min-h-[900px]">
            <div>
              <div className="flex items-center gap-3 mb-12">
                <div className="h-10 w-10 rounded-lg bg-gradient-to-tr from-[#FF4F21] to-[#FF8433] flex items-center justify-center font-bold text-sm">
              ...
              <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-zinc-900 border border-zinc-800 text-sm font-bold text-zinc-300 print:border-zinc-500">
                <Shield className="h-4 w-4 text-[#FF4F21]" /> {tier}
              </div>
            </div>

            <div className="grid grid-cols-2 gap-8 border-t border-zinc-800 pt-8 mt-12">
              <div>
        ...
        ========================================= */}
        <div className="bg-zinc-950 text-white rounded-2xl border border-zinc-800 print:rounded-none print:border-none print:min-h-screen p-12" style={{ WebkitPrintColorAdjust: 'exact', printColorAdjust: 'exact' }}>
          <div className="flex items-center gap-3 border-b border-zinc-800 pb-4 mb-10">
          ...
          <div className="grid grid-cols-3 gap-6 mb-12">
            <div className="bg-zinc-900 border border-zinc-800 rounded-xl p-8 flex flex-col items-center justify-center text-center relative overflow-hidden">
              ...
              <div className="relative h-32 w-32 relative z-10">
        ...
        <div className="bg-zinc-950 text-white rounded-2xl border border-zinc-800 print:rounded-none print:border-none print:min-h-screen p-12" style={{ WebkitPrintColorAdjust: 'exact', printColorAdjust: 'exact' }}>
          ...
          <div className="grid grid-cols-3 gap-4">
            <div className="aspect-[4/5] rounded-xl bg-zinc-900 border border-zinc-800 relative overflow-hidden flex flex-col justify-end p-4">
              <Activity className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 h-12 w-12 text-zinc-800" />
        ...
        <div className="bg-zinc-950 text-white rounded-2xl border border-zinc-800 print:rounded-none print:border-none print:min-h-screen p-12" style={{ WebkitPrintColorAdjust: 'exact', printColorAdjust: 'exact' }}>
          ...
          <div className="text-center pt-16 border-t border-zinc-800 mt-auto">
