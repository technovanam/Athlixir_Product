  ...
  return (
    <div className="p-8 md:p-12 text-center space-y-8 animate-fadeIn relative overflow-hidden">
      ...
      <div className="flex flex-col items-center justify-center space-y-4">
        <div className="h-16 w-16 rounded-full bg-gradient-to-tr from-[#FF4F21] to-[#FF8433] flex items-center justify-center shadow-lg shadow-[#FF4F21]/30 ring-4 ring-[#FF4F21]/10">
      ...
      {profileData && (
        <div className="max-w-md mx-auto grid grid-cols-2 gap-3.5 text-left border-t border-b border-zinc-900 py-6 my-6">
          ...
          <div className="rounded-xl border border-zinc-900 bg-zinc-950/20 p-3.5 flex items-center gap-3">
            <ShieldCheck className="h-5 w-5 text-[#FF4F21] shrink-0" />
            <div>
      ...
      <div className="flex justify-center pt-4">
        <button
          ...
          className="flex items-center gap-2 px-8 py-3.5 rounded-xl bg-gradient-to-r from-[#FF4F21] to-[#FF8433] hover:from-[#FF8433] hover:to-[#FF4F21] text-xs font-bold text-white shadow-lg shadow-[#FF4F21]/20 hover:scale-[1.02] transition duration-200 cursor-pointer"
        >
